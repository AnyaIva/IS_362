...
LOAD DATA INFILE 'C:\Users\sbana\Downloads\flights(1)/airlines.csv' 
INTO TABLE airlines 
...
LOAD DATA INFILE 'C:\Users\sbana\Downloads\flights(1)/airports.csv' 
INTO TABLE airports
FIELDS TERMINATED BY ',' 
ENCLOSED BY '"'
LINES TERMINATED BY '\n'
...
LOAD DATA INFILE 'C:\Users\sbana\Downloads\flights(1)/flights.csv' 
INTO TABLE flights
FIELDS TERMINATED BY ',' 
ENCLOSED BY '"'
LINES TERMINATED BY '\n'
...
LOAD DATA INFILE 'C:\Users\sbana\Downloads\flights(1)/planes.csv' 
INTO TABLE planes
FIELDS TERMINATED BY ',' 
ENCLOSED BY '"'
LINES TERMINATED BY '\n'
...
LOAD DATA INFILE 'C:\Users\sbana\Downloads\flights(1)/weather.csv' 
INTO TABLE weather
FIELDS TERMINATED BY ',' 
ENCLOSED BY '"'
LINES TERMINATED BY '\n'
